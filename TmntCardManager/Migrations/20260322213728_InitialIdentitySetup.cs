    ...
    public partial class InitialIdentitySetup : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("cardclasses_pkey", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    winrate = table.Column<double>(type: "double precision", nullable: false, defaultValueSql: "0.0"),
                    avatarurl = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("playerprofiles_pkey", x => x.id);
                    table.ForeignKey(
                        name: "fk_playerprofile_users",
                        column: x => x.id,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("deckcards_pkey", x => x.id);
                    table.ForeignKey(
                        name: "fk_deckcards_card",
                        column: x => x.cardid,
                        principalTable: "cards",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_deckcards_deck",
                        column: x => x.deckid,
